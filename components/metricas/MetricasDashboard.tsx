...
import type { GoogleAdsCampaignRow, MetaAdsCampaignRow, CreativeRow } from "@/lib/data/performance";
...
interface Props {
  ...
  googleAdsKeywords?: GoogleAdsKeywordRow[];
  metaAdsCampaigns?: MetaAdsCampaignRow[];
